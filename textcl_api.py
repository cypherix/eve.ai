...
training_data = []
training_data.append({"class":"edu", "sentence":"Bachelors degree Indian Institue of Technology"})
training_data.append({"class":"edu", "sentence":"Studied College University Institute School GPA Bachelors degree"})
